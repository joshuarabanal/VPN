    ...
    public void run(){
        while(true){
            ...
            try {
                ...
                if(s.destinationIpAddress == s.sourceIpAddress && s.destinationIpAddress == searchingIp){
                    System.out.println("found correct Ip: "+ s.toString());
                        s.bindPacket();
                }
                else{
                    System.out.println("not correct Ip: "+ Socket.ipIntToString(s.sourceIpAddress));
                }
